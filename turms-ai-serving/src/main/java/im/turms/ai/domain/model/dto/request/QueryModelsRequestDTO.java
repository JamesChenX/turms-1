...
package im.turms.ai.domain.model.dto.request;
...
@Data
public class QueryModelsRequestDTO
        extends QueryRequestWithPaginationDTO<QueryModelsRequestDTO.FilterDTO> {
    ...
    public static class FilterDTO extends RequestFilterDTO {
        @Nullable
        @Schema(description = "Filter by model IDs")
