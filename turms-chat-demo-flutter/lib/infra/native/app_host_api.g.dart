...
class DiskSpaceInfo {
  ...
  static DiskSpaceInfo decode(Object result) {
    result as List<Object?>;
    return DiskSpaceInfo(
      total: result[0]! as int,
      free: result[1]! as int,
      usable: result[2]! as int,
    );
  }
}

class _AppHostApiCodec extends StandardMessageCodec {
  const _AppHostApiCodec();
  @override
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is DiskSpaceInfo) {
      buffer.putUint8(128);
...
class AppHostApi {
  ...
  AppHostApi({BinaryMessenger? binaryMessenger})
  ...
  Future<DiskSpaceInfo> getDiskSpace(String path) async {
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as DiskSpaceInfo?)!;
    }
  }
}
