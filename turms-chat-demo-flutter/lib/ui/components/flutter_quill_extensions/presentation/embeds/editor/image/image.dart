...
import '../../../../../flutter_quill/flutter_quill.dart' as base;
import '../../../../../flutter_quill/flutter_quill.dart' hide OptionalSize;
import '../../../../../flutter_quill/src/l10n/widgets/localizations.dart';
...
class QuillEditorImageEmbedBuilder extends EmbedBuilder {
  ...
  Widget build(
    ...
    final imageSource = standardizeImageUrl(node.value.data as String);
