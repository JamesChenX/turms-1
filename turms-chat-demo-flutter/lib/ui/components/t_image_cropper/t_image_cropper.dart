...
class _CropEditorState extends State<_CropEditor> {
  ...
  void _resetCropRect() {
    ...
    final initialRectBuilder = widget.initialRectBuilder;
    if (initialRectBuilder != null) {
      cropRect = initialRectBuilder(
        Rect.fromLTWH(
          0,
          0,
          screenSize.width,
  ...
  @override
  Widget build(BuildContext context) => _isImageLoading
      ...
      : Stack(
          ...
          children: [
            ...
            IgnorePointer(
              child: ClipPath(
                clipper: CropAreaClipper(_cropRect, widget.radius),
                child: Container(
            ...
            Positioned(
              left: _cropRect.left - (dotContainerSize / 2),
              top: _cropRect.top - (dotContainerSize / 2),
              child: GestureDetector(
                ...
                child: widget.cornerDotBuilder
                        ?.call(dotContainerSize, EdgeAlignment.topLeft) ??
                    const DotControl(),
              ),
            ),
            Positioned(
              left: _cropRect.right - (dotContainerSize / 2),
              top: _cropRect.top - (dotContainerSize / 2),
              child: GestureDetector(
                onPanUpdate: widget.fixCropRect
                    ? null
                ...
                child: widget.cornerDotBuilder
                        ?.call(dotContainerSize, EdgeAlignment.topRight) ??
                    const DotControl(),
              ),
            ),
            Positioned(
              left: _cropRect.left - (dotContainerSize / 2),
              top: _cropRect.bottom - (dotContainerSize / 2),
              child: GestureDetector(
                onPanUpdate: widget.fixCropRect
                    ? null
                    : (details) {
                ...
                child: widget.cornerDotBuilder
                        ?.call(dotContainerSize, EdgeAlignment.bottomLeft) ??
                    const DotControl(),
              ),
            ),
            Positioned(
              ...
              child: GestureDetector(
                ...
                child: widget.cornerDotBuilder
                        ?.call(dotContainerSize, EdgeAlignment.bottomRight) ??
                    const DotControl(),
              ),
            ),
          ],
