      ...
      Column(spacing: 4, children: [
        TIconButton(
            ...
            onTap: () => ref.read(homePageTabViewModel.notifier).state =
                HomePageTab.chat,
            iconColor: isChatTab ? theme.primaryColor : Colors.white54,
            iconColorHovered: isChatTab ? theme.primaryColor : Colors.white70),
        TIconButton(
            ...
            iconColor: isContactsTab ? theme.primaryColor : Colors.white54,
            iconColorHovered:
                isContactsTab ? theme.primaryColor : Colors.white70),
        TIconButton(
