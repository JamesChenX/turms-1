 ...
 * @author James Chen
 */
public record QueryFlightRecordingsAsFilesRequestDTO(
        FilterDTO filter
) implements QueryRequestWithPaginationDTO<QueryFlightRecordingsAsFilesRequestDTO.FilterDTO> {

    public record FilterDTO(
            @Schema(description = "Filter by flight recording IDs") LinkedHashSet<Long> ids
