 ...
 * @author James Chen
 */
public record QueryLogsRequestDTO(
        FilterDTO filter
) implements QueryRequestWithPaginationDTO<QueryLogsRequestDTO.FilterDTO> {

    public record FilterDTO(
            @Schema(description = "The liveness of the objects") Liveness liveness
