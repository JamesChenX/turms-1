...
@Data
public class UpdateFlightRecordingsRequestDTO extends
        UpdateRequestWithFilterDTO<UpdateFlightRecordingsRequestDTO.FilterDTO, UpdateFlightRecordingsRequestDTO.UpdateDTO> {

    @Accessors(fluent = true)
    @EqualsAndHashCode(callSuper = true)
    @Data
    public static class FilterDTO extends RequestFilterDTO {
        @Schema(description = "Filter by flight recording IDs")
    ...
    @EqualsAndHashCode(callSuper = true)
    @Data
    public static final class UpdateDTO extends RequestUpdateDTO {
