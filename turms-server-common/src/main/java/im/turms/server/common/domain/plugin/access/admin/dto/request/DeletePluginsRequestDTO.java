...
@Data
public class DeletePluginsRequestDTO
        extends DeleteRequestWithFilterDTO<DeletePluginsRequestDTO.FilterDTO> {

    @Schema(description = "Whether to delete local found files")
