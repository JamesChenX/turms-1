 ...
 * @author James Chen
 */
public record DeleteAdminRolesRequestDTO(
        FilterDTO filter,
        boolean deleteAll
) implements DeleteRequestWithFilterDTO<DeleteAdminRolesRequestDTO.FilterDTO> {

    public record FilterDTO(
            @Schema(description = "Filter by admin role IDs") LinkedHashSet<Long> ids
