 ...
 * @author James Chen
 */
public record CreateBlockedIpsRequestDTO(
        List<NewBlockedIpDTO> records
) implements CreateRecordsRequestDTO<CreateBlockedIpsRequestDTO.NewBlockedIpDTO> {

    public record NewBlockedIpDTO(
            @Schema(description = "The IP address to block", required = true) String ip,
            @Schema(
