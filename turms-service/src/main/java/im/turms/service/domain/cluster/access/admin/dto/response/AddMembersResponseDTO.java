...
public class AddMembersResponseDTO
        extends CreateRecordsResponseDTO<AddMembersResponseDTO, MemberDTO> {

    public AddMembersResponseDTO(List<MemberDTO> records) {
        super(records);
    }

    public static AddMembersResponseDTO of(List<Member> members) {
        return new AddMembersResponseDTO(CollectionUtil.transformAsList(members, MemberDTO::from));
    }
