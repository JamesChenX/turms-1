...
public class QueryConversationsRequest
        extends QueryRequestWithPaginationDTO<QueryConversationsRequest.FilterDTO> {

    @Accessors(fluent = true)
    @EqualsAndHashCode(callSuper = true)
    @Data
    public static class FilterDTO extends RequestFilterDTO {
        private List<PrivateConversation.Key> privateConversationIds;
        private LinkedHashSet<Long> ownerIds;
