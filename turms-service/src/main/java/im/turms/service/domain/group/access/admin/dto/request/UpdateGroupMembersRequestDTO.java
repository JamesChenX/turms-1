 ...
 * @author James Chen
 */
public record UpdateGroupMembersRequestDTO(
        FilterDTO filter,
        UpdateDTO update
) implements
        UpdateRequestWithFilterDTO<UpdateGroupMembersRequestDTO.FilterDTO, UpdateGroupMembersRequestDTO.UpdateDTO> {

    public record FilterDTO(
            @Schema(description = "The group member IDs") List<GroupMember.Key> groupMemberIds
    ) implements RequestFilterDTO {
    }

    public record UpdateDTO(
            @Schema(description = "New name") String name,
            @Schema(description = "New role") GroupMemberRole role,
            @Schema(description = "New join date") Date joinDate,
