...
public class MessageService {
    ...
    private boolean sendMessageToSenderOtherOnlineSessions;
    @Getter
    ...
    private void updateProperties(TurmsProperties properties) {
        ...
        sendMessageToSenderOtherOnlineSessions = serviceProperties.getNotification()
                .getMessageCreated()
...
//    }
    ...
    private Mono<Void> sendMessage(
        ...
        if (sendMessageToSenderOtherOnlineSessions && senderDeviceType != null) {
